...
class IllegalCharError(Error):
  def __init__(self, pos_start, pos_end, details):
    super().__init__(pos_start, pos_end, 'Tomato Caught ICE:\nIllegal Character', details)

class ExpectedCharError(Error):
  def __init__(self, pos_start, pos_end, details):
    super().__init__(pos_start, pos_end, 'Tomato Caught ECE:\nExpected Character', details)

class InvalidSyntaxError(Error):
  def __init__(self, pos_start, pos_end, details=''):
    super().__init__(pos_start, pos_end, 'Tomato Caught ISE:\nInvalid Syntax', details)

class RTError(Error):
  def __init__(self, pos_start, pos_end, details, context):
    super().__init__(pos_start, pos_end, 'Tomato Caught RTE: Runtime Error', details)
...
class BuiltInFunction(BaseFunction):
  ...
  def execute_fopen(self, exec_ctx):
    try:
  ...
  execute_fopen.arg_names = ['value']

  def execute_fwrite(self, exec_ctx):
    ...
    try:
      ...
      print("\u001b[31m"+str(e.args)+"\u001b[0m")
  execute_fwrite.arg_names = ['value', 'content']
  ...
  def execute_browser(self, exec_ctx):
    webbrowser.open_new_tab(str(exec_ctx.symbol_table.get('value')))
    return RTResult().success(Number.null)
  execute_browser.arg_names = ['value']
  ...
  def execute_cmd(self, exec_ctx):
    os.system(str(exec_ctx.symbol_table.get('value')))
    return RTResult().success(Number.null)
  execute_cmd.arg_names = ['value']
  ...
  def execute_mouseto(self, exec_ctx):
      
      
    numA = (exec_ctx.symbol_table.get("numA"))
    numB = (exec_ctx.symbol_table.get("numB"))
    xPos =(int(str(numA)))
    yPos =(int(str(numB)))
    pag.moveTo(xPos, yPos)
    
    return RTResult().success(Number.null)
  execute_mouseto.arg_names = ["numA", "numB"]

  def execute_mousefrom(self, exec_ctx):
    ...
    return RTResult().success(Number.null)
  execute_mousefrom.arg_names = ["numA", "numB"]


  def execute_mousehold(self, exec_ctx):
      
      
    button = exec_ctx.symbol_table.get('value')
    if str(button) == "left":
    ...
    return RTResult().success(Number.null)
  execute_mousehold.arg_names = ["value"]

  def execute_wait(self, exec_ctx):
      
    
    pausefor = str(exec_ctx.symbol_table.get('value'))
    if "." in pausefor:
      time.sleep(float(pausefor))
    else:
      time.sleep(int(pausefor))
    return RTResult().success(Number.null)
  execute_wait.arg_names = ["value"]

  def execute_mouseup(self, exec_ctx):
    ...
    return RTResult().success(Number.null)
  execute_mouseup.arg_names = ["value"]

  def execute_key(self, exec_ctx):
      
      
    key = exec_ctx.symbol_table.get('value')
    key = str(key)
    pag.press(key)
    ...
    return RTResult().success(Number.null)
  execute_key.arg_names = ["value"]

  def execute_keyhold(self, exec_ctx):
    ...
    return RTResult().success(Number.null)
  execute_keyhold.arg_names = ["value"]

  def execute_keyboard(self, exec_ctx):
      
      
    text = str(exec_ctx.symbol_table.get("string"))
    interval = float(str(exec_ctx.symbol_table.get("interval")))
    
    pag.typewrite(text, interval)
      
    
    return RTResult().success(Number.null)
  execute_keyboard.arg_names = ["string", "interval"]

  def execute_hotkey(self, exec_ctx):
      
      
    hk1 = str(exec_ctx.symbol_table.get("hk1"))
    hk2 = str(exec_ctx.symbol_table.get("hk2"))
    ...
    return RTResult().success(Number.null)
  execute_hotkey.arg_names = ["hk1", "hk2"]

  def execute_keyup(self, exec_ctx):
    ...
    return RTResult().success(Number.null)
  execute_keyup.arg_names = ["value"]

  def execute_mouse(self, exec_ctx):
    ...
    return RTResult().success(Number.null)
  execute_mouse.arg_names = ["value"]

  def execute_getmousex(self, exec_ctx):
      
      
    pos = pag.position()
    x = Number(int(str(pos[0])))
      
    
    return RTResult().success(x)
  execute_getmousex.arg_names = []

  def execute_getmousey(self, exec_ctx):
      
      
    pos = pag.position()
    y = Number(int(str(pos[1])))
      
    
    return RTResult().success(y)
  execute_getmousey.arg_names = []

  def execute_getboundsx(self, exec_ctx):
      
      
    bounds = pag.size()
    x = Number(int(str(bounds[0])))
    
    return RTResult().success(x)
  execute_getboundsx.arg_names = []

  def execute_getboundsy(self, exec_ctx):
      
      
    bounds = pag.size()
    y = Number(int(str(bounds[1])))
      
    
    return RTResult().success(y)
  execute_getboundsy.arg_names = []

  def execute_mousescroll(self, exec_ctx):
      
      
    units = int(str(exec_ctx.symbol_table.get('value')))
    pag.scroll(units)
      
    
    return RTResult().success(Number.null)
  execute_mousescroll.arg_names = ["value"]
...
String.getdate = String(str(datetime.datetime.now()))
...
BuiltInFunction.browser      = BuiltInFunction("browser")

BuiltInFunction.cmd      = BuiltInFunction("cmd")
BuiltInFunction.msg      = BuiltInFunction("msg")

BuiltInFunction.mouseto      = BuiltInFunction("mouseto")
BuiltInFunction.mousefrom      = BuiltInFunction("mousefrom")
BuiltInFunction.mousehold      = BuiltInFunction("mousehold")
BuiltInFunction.mouseup      = BuiltInFunction("mouseup")
BuiltInFunction.mouse      = BuiltInFunction("mouse")
BuiltInFunction.mousescroll      = BuiltInFunction("mousescroll")

BuiltInFunction.wait      = BuiltInFunction("wait")
BuiltInFunction.mailset      = BuiltInFunction("mailset")
BuiltInFunction.mailsend      = BuiltInFunction("mailsend")

BuiltInFunction.run					= BuiltInFunction("run")
BuiltInFunction.getmousex      = BuiltInFunction("getmousex")
BuiltInFunction.getmousey      = BuiltInFunction("getmousey")




BuiltInFunction.getboundsx      = BuiltInFunction("getboundsx")
BuiltInFunction.getboundsy      = BuiltInFunction("getboundsy")



BuiltInFunction.keyboard      = BuiltInFunction("keyboard")
BuiltInFunction.key      = BuiltInFunction("key")
BuiltInFunction.keyhold      = BuiltInFunction("keyhold")
BuiltInFunction.hotkey      = BuiltInFunction("hotkey")
BuiltInFunction.keyup      = BuiltInFunction("keyup")
...
BuiltInFunction.fopen   = BuiltInFunction("fopen")
BuiltInFunction.fwrite   = BuiltInFunction("fwrite")
...
global_symbol_table.set("getdate", String.getdate)
global_symbol_table.set("getmousex", BuiltInFunction.getmousex)
global_symbol_table.set("getmousey", BuiltInFunction.getmousey)
...
global_symbol_table.set("browser", BuiltInFunction.browser)

global_symbol_table.set("cmd", BuiltInFunction.cmd)
global_symbol_table.set("msg", BuiltInFunction.msg)


global_symbol_table.set("mouseto", BuiltInFunction.mouseto)
global_symbol_table.set("mousefrom", BuiltInFunction.mousefrom)
global_symbol_table.set("mousehold", BuiltInFunction.mousehold)
global_symbol_table.set("mouseup", BuiltInFunction.mouseup)
global_symbol_table.set("mouse", BuiltInFunction.mouse)

global_symbol_table.set("mousescroll", BuiltInFunction.mousescroll)
global_symbol_table.set("wait", BuiltInFunction.wait)
global_symbol_table.set("mailset", BuiltInFunction.mailset)
global_symbol_table.set("mailsend", BuiltInFunction.mailsend)




global_symbol_table.set("mailsend", BuiltInFunction.mailsend)
global_symbol_table.set("getboundsx", BuiltInFunction.getboundsx)
global_symbol_table.set("getboundsy", BuiltInFunction.getboundsy)
global_symbol_table.set("keyboard", BuiltInFunction.keyboard)

global_symbol_table.set("key", BuiltInFunction.key)
global_symbol_table.set("keyhold", BuiltInFunction.keyhold)
global_symbol_table.set("hotkey", BuiltInFunction.hotkey)
global_symbol_table.set("keyup", BuiltInFunction.keyup)
...
global_symbol_table.set("fopen", BuiltInFunction.fopen)
global_symbol_table.set("fwrite", BuiltInFunction.fwrite)
